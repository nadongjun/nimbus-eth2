...
func increase_balance*(state: var ForkyBeaconState, index: ValidatorIndex, delta: Gwei) =
...
func decrease_balance*(state: var ForkyBeaconState, index: ValidatorIndex, delta: Gwei) =
...
proc slash_validator*(
  ...
  let proposer_index =
    get_beacon_proposer_index(state, cache).valueOr:
