...
proc writeValue*(writer: var JsonWriter, value: JustificationBits) {.raises: [IOError].} =
...
func init*(T: type GraffitiBytes, input: string): GraffitiBytes {.raises: [ValueError].} =
