...
func init*(t: typedesc[RestBlockInfo], v: ForkedTrustedSignedBeaconBlock): RestBlockInfo =
  withBlck(v):
...
func init*(t: typedesc[RestErrorMessage], code: int, message: string): RestErrorMessage =
