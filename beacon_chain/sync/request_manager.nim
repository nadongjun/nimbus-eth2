...
proc checkResponse(idList: seq[BlobIdentifier], blobs: openArray[ref BlobSidecar]): bool =
...
proc fetchBlobsFromNetwork(self: RequestManager, idList: seq[BlobIdentifier]) {.async.} =
  var peer: Peer
