...
proc runTests(keymanager: KeymanagerToTest) {.async.} =
  ...
  suite "Serialization/deserialization" & testFlavour:
    func `==`(a, b: Kdf): bool =
      ...
      of KdfKind.kdfPbkdf2:
        (a.pbkdf2Params.dklen == b.pbkdf2Params.dklen) and (
          a.pbkdf2Params.c == b.pbkdf2Params.c
        ) and (a.pbkdf2Params.prf == b.pbkdf2Params.prf) and (
      ...
      of KdfKind.kdfScrypt:
        (a.scryptParams.dklen == b.scryptParams.dklen) and (
          a.scryptParams.n == b.scryptParams.n
        ) and (a.scryptParams.p == b.scryptParams.p) and (
          a.scryptParams.r == b.scryptParams.r
        ) and (seq[byte](a.scryptParams.salt) == seq[byte](b.scryptParams.salt))
    ...
    func `==`(a, b: Keystore): bool =
      ...
      ) and (a.description == b.description) and (a.uuid == b.uuid) and (
        a.version == b.version
      )
